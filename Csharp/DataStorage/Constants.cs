...
{
    public const string parsePath = "D:\\1\\all";
    //public const string rootPath = "D:\\1\\";
    public const string AdjOneDatafile = "AdjOne.npy";
    public const string AdjZeroDatafile = "AdjZero.npy";
